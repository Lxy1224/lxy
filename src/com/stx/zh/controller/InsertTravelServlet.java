...
/**
 * Servlet implementation class InsertTravelServlet
 */
@WebServlet("/InsertTravelServlet")
public class InsertTravelServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public InsertTravelServlet() {
        super();
